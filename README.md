...
- 💼 **Rainbow Wallet Integration**: Connect using Rainbow wallet extension
...
│   ├── src/
│   │   ├── components/
│   │   │   ├── HabitMoodLogger.tsx      # Submit daily records
│   │   │   ├── HabitMoodViewer.tsx      # View and decrypt records
│   │   │   ├── HabitMoodAnalysis.tsx    # Display analysis results
