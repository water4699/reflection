...
export async function signEIP712(signer, domain, types, message) {
...
export async function multiSignEIP712(signers, domain, types, message) {
    const signatures = [];
...
export function assertIsEIP712Domain(eip712Domain, name, expectedDomain) {
...
export function isThresholdReached(signersAddress, recoveredAddresses, threshold, signerType) {
