 ...
 */
export async function getCoprocessorConfig(provider, contractAddress) {
    ...
    */
    const addresses = await getAddressesFromStorage(provider, contractAddress, coprocessorConfigStorageLocation, 4 /* number of addresses in the struct */);
    return {
