...
export const allFhevmTypeNames = [
    "ebool",
    "euint4",
    "euint8",
    "euint16",
...
*/
export const allFhevmTypeInfos = Object.freeze([
    Object.freeze({
 ...
 * @param fhevmType
 */
export function isFhevmType(fhevmType) {
    if (!isUInt(fhevmType)) {
        return false;
    }
 ...
 * @param fhevmType
 */
export function isFhevmEbytes(fhevmType) {
 ...
 * @param fhevmType
 */
export function isFhevmEuint(fhevmType) {
 ...
 * @param fhevmType
 */
export function isFhevmEbool(fhevmType) {
 ...
 * @param fhevmType
 */
export function isFhevmEaddress(fhevmType) {
 ...
 * @param fhevmType
 */
export function checkFhevmType(fhevmType) {
    if (!isFhevmType(fhevmType)) {
        throw new FhevmError(`Invalid FhevmType ${fhevmType}`);
    }
}
export function FheTypeToFhevmType(fheType) {
...
export function FhevmTypeToFheType(fhevmType) {
...
export function getFhevmTypeInfo(type) {
 ...
 */
export function getFhevmTypeFheBitLength(fhevmType) {
    const fheType = FhevmTypeToFheType(fhevmType);
    return getFheTypeBitLength(fheType);
}
export function getFhevmTypeMaxClearTextBigInt(fhevmType) {
...
export function tryParseFhevmType(name) {
