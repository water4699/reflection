...
exports.CoprocessorEventsIterator = void 0;
...
class CoprocessorEventsIterator {
    constructor(coprocessorContractInterface, coprocessorContractAddress, readonlyProvider, fromBlockNumber) {
        ...
        __classPrivateFieldSet(this, _CoprocessorEventsIterator_cursor, new event_js_1.BlockLogCursor(fromBlockNumber), "f");
    }
    async next() {
...
exports.CoprocessorEventsIterator = CoprocessorEventsIterator;
